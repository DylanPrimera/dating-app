...
>(({ className, children, ...props }, ref) => (
	<SelectPrimitive.Trigger
		ref={ref}
		className={cn(
			"flex h-9 w-full text-gray-900 items-center justify-between whitespace-nowrap rounded-md border border-neutral-200 bg-transparent px-3 py-2 text-sm shadow-sm ring-offset-white outline-none placeholder:text-neutral-500 focus:outline-none focus:ring-1 focus:ring-transparent disabled:cursor-not-allowed aria-selected:outline-none focus-visible:outline-none disabled:opacity-50 [&>span]:line-clamp-1 dark:border-neutral-800 dark:ring-offset-neutral-950 dark:placeholder:text-neutral-400 dark:focus:ring-neutral-300",
			className,
		)}
		{...props}
	>
